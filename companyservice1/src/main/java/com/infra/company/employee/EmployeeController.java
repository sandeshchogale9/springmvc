...
import com.infra.company.Company;
import com.infra.company.CompanyService;
...
public class EmployeeController {
	...
	public void createEmployee(@PathVariable String companyName, @RequestBody Employee emp) {
		// Without this user would need to mention the company in the json while
		// passing.
	...
	public void updateEmployee(@RequestBody Employee employee, @PathVariable String companyName,
