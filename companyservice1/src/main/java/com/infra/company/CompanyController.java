...
public class CompanyController {
	...
	public List<Company> getCompanies() {
		 ...
		 * 
		 * return Arrays.asList( new Company("Infosys", "Infosys India Pvt Ltd.",
		 * 100000), new Company("Oracle", "Oracle India Pvt Ltd.", 50000), new
		 * Company("MI", "MobileIron India Pvt Ltd.", 850) );
		 */
